        ...
        @if ($post->layout == 'Sidebar')
            <div class="card mb-3">
                <div class="row">
                    ...
                    <div class="col-md-4"
                        style=" background-image: urL('/storage/{{ $post->image }}'); background-size: cover; background-position: center; ">
                    </div>

                </div>
            </div>
        @elseif ($post->layout == 'Blog')
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        <img class="card-img-top" src="/storage/{{ $post->image }}" alt="Title">
                        <div class="card-body">
                            <h1 class="mb-4">{{ $post->title }}</h1>
                            {!! $post->content !!}
                        </div>
